...
contract ToshiToken is ERC20, Ownable {
    ...
    constructor() ERC20("Toshi", "TOSHI") {
        ...
        address toshiMultisig = 0x0977250DbeFE33086Cebfb73970E0473c592fc54;
        ...
        marketingWallet = toshiMultisig;
        developmentWallet = toshiMultisig;
        liquidityWallet = toshiMultisig;

        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(deadAddress, true);
        excludeFromFees(toshiMultisig, true);

        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(deadAddress, true);
        excludeFromMaxTransaction(address(uniswapV2Router), true);
        excludeFromMaxTransaction(toshiMultisig, true);
