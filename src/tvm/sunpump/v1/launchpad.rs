...
pub mod events {
    ...
    impl substreams_ethereum::Event for TokenCreateV1 {
        const NAME: &'static str = "TokenCreateV1";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl substreams_ethereum::Event for TokenCreateV2 {
        const NAME: &'static str = "TokenCreateV2";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
