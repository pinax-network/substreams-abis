...
pub mod functions {
    ...
    impl AddLiquidity {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::Tuple(vec![
                ...
                ethabi::Token::Bytes(self.params.5.clone()),
            ])]);
    ...
    impl Erc4626BufferWrapOrUnwrap {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::Tuple(vec![
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.params.0.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.params.1.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
    ...
    impl Swap {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::Tuple(vec![
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.vault_swap_params.0.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Address(ethabi::Address::from_slice(&self.vault_swap_params.1)),
                ethabi::Token::Address(ethabi::Address::from_slice(&self.vault_swap_params.2)),
                ethabi::Token::Address(ethabi::Address::from_slice(&self.vault_swap_params.3)),
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.vault_swap_params.4.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.vault_swap_params.5.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Bytes(self.vault_swap_params.6.clone()),
            ])]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
...
pub mod events {
    ...
    impl AggregateSwapFeePercentageChanged {
        const TOPIC_ID: [u8; 32] = [
            228u8, 211u8, 113u8, 9u8, 123u8, 238u8, 164u8, 36u8, 83u8, 163u8, 116u8, 6u8, 226u8,
            174u8, 244u8, 192u8, 79u8, 60u8, 84u8, 143u8, 132u8, 172u8, 80u8, 231u8, 37u8, 120u8,
            102u8, 44u8, 13u8, 205u8, 115u8, 84u8,
        ];
    ...
    impl AggregateYieldFeePercentageChanged {
        const TOPIC_ID: [u8; 32] = [
            96u8, 110u8, 185u8, 125u8, 131u8, 22u8, 75u8, 214u8, 178u8, 0u8, 214u8, 56u8, 205u8,
            73u8, 193u8, 76u8, 101u8, 217u8, 77u8, 79u8, 44u8, 103u8, 76u8, 253u8, 133u8, 226u8,
            78u8, 14u8, 32u8, 44u8, 60u8, 165u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl Approval {
        const TOPIC_ID: [u8; 32] = [
            160u8, 23u8, 83u8, 96u8, 161u8, 91u8, 202u8, 50u8, 139u8, 175u8, 126u8, 168u8, 92u8,
            123u8, 120u8, 77u8, 88u8, 178u8, 34u8, 165u8, 13u8, 12u8, 231u8, 96u8, 177u8, 13u8,
            186u8, 51u8, 109u8, 34u8, 106u8, 97u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            ...
            Ok(Self {
                ...
                owner: ethabi::decode(&[ethabi::ParamType::Address], log.topics[2usize].as_ref())
                    ...
                    .as_bytes()
                    .to_vec(),
                spender: ethabi::decode(&[ethabi::ParamType::Address], log.topics[3usize].as_ref())
                    .map_err(|e| {
                        format!(
    ...
    impl BufferSharesBurned {
        const TOPIC_ID: [u8; 32] = [
            78u8, 9u8, 247u8, 247u8, 252u8, 55u8, 206u8, 40u8, 151u8, 128u8, 14u8, 44u8, 42u8,
            144u8, 153u8, 86u8, 94u8, 219u8, 10u8, 19u8, 61u8, 25u8, 216u8, 74u8, 104u8, 113u8,
            179u8, 83u8, 10u8, 248u8, 132u8, 107u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl BufferSharesMinted {
        const TOPIC_ID: [u8; 32] = [
            214u8, 111u8, 3u8, 29u8, 51u8, 56u8, 28u8, 100u8, 8u8, 240u8, 179u8, 44u8, 136u8, 68u8,
            97u8, 229u8, 222u8, 61u8, 248u8, 128u8, 131u8, 153u8, 182u8, 243u8, 163u8, 216u8,
            107u8, 19u8, 104u8, 248u8, 236u8, 52u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
    ...
    impl LiquidityAdded {
        const TOPIC_ID: [u8; 32] = [
            162u8, 106u8, 82u8, 216u8, 213u8, 55u8, 2u8, 187u8, 167u8, 241u8, 55u8, 144u8, 123u8,
            142u8, 31u8, 153u8, 255u8, 135u8, 246u8, 212u8, 80u8, 20u8, 66u8, 112u8, 202u8, 37u8,
            231u8, 36u8, 129u8, 204u8, 168u8, 113u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 4usize {
                return false;
    ...
    impl LiquidityAddedToBuffer {
        const TOPIC_ID: [u8; 32] = [
            117u8, 196u8, 220u8, 95u8, 35u8, 100u8, 14u8, 235u8, 167u8, 212u8, 4u8, 217u8, 22u8,
            95u8, 81u8, 95u8, 195u8, 217u8, 226u8, 58u8, 92u8, 139u8, 110u8, 45u8, 9u8, 180u8,
            185u8, 218u8, 86u8, 255u8, 0u8, 169u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl LiquidityRemoved {
        const TOPIC_ID: [u8; 32] = [
            251u8, 229u8, 176u8, 215u8, 159u8, 185u8, 79u8, 30u8, 129u8, 192u8, 169u8, 43u8, 248u8,
            106u8, 233u8, 211u8, 161u8, 158u8, 157u8, 27u8, 246u8, 32u8, 44u8, 13u8, 62u8, 117u8,
            18u8, 15u8, 101u8, 213u8, 216u8, 165u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 4usize {
                return false;
    ...
    impl LiquidityRemovedFromBuffer {
        const TOPIC_ID: [u8; 32] = [
            68u8, 217u8, 123u8, 54u8, 233u8, 155u8, 89u8, 11u8, 61u8, 40u8, 117u8, 170u8, 211u8,
            177u8, 103u8, 177u8, 215u8, 251u8, 30u8, 6u8, 63u8, 63u8, 19u8, 37u8, 161u8, 238u8,
            172u8, 118u8, 202u8, 238u8, 81u8, 19u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl PoolInitialized {
        const TOPIC_ID: [u8; 32] = [
            202u8, 216u8, 201u8, 211u8, 37u8, 7u8, 57u8, 59u8, 101u8, 8u8, 202u8, 74u8, 136u8,
            139u8, 129u8, 151u8, 153u8, 25u8, 180u8, 119u8, 81u8, 5u8, 133u8, 189u8, 232u8, 72u8,
            143u8, 21u8, 48u8, 114u8, 214u8, 243u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl PoolPausedStateChanged {
        const TOPIC_ID: [u8; 32] = [
            87u8, 226u8, 4u8, 72u8, 2u8, 130u8, 151u8, 25u8, 1u8, 34u8, 87u8, 27u8, 231u8, 203u8,
            108u8, 27u8, 30u8, 248u8, 87u8, 48u8, 198u8, 115u8, 247u8, 199u8, 47u8, 83u8, 60u8,
            134u8, 98u8, 65u8, 154u8, 167u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl PoolRecoveryModeStateChanged {
        const TOPIC_ID: [u8; 32] = [
            194u8, 53u8, 76u8, 194u8, 247u8, 142u8, 165u8, 119u8, 119u8, 229u8, 93u8, 221u8, 67u8,
            167u8, 242u8, 43u8, 17u8, 44u8, 233u8, 136u8, 104u8, 89u8, 104u8, 128u8, 237u8, 174u8,
            178u8, 43u8, 79u8, 156u8, 115u8, 169u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl PoolRegistered {
        const TOPIC_ID: [u8; 32] = [
            188u8, 21u8, 97u8, 238u8, 171u8, 159u8, 64u8, 150u8, 46u8, 47u8, 184u8, 39u8, 167u8,
            255u8, 156u8, 124u8, 219u8, 71u8, 169u8, 215u8, 200u8, 76u8, 174u8, 239u8, 164u8,
            237u8, 144u8, 224u8, 67u8, 132u8, 45u8, 173u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            ...
            Ok(Self {
                pool: ethabi::decode(&[ethabi::ParamType::Address], log.topics[1usize].as_ref())
                    ...
                    .as_bytes()
                    .to_vec(),
                factory: ethabi::decode(&[ethabi::ParamType::Address], log.topics[2usize].as_ref())
                    .map_err(|e| {
                        format!(
    ...
    impl ProtocolFeeControllerChanged {
        const TOPIC_ID: [u8; 32] = [
            40u8, 10u8, 96u8, 177u8, 230u8, 60u8, 23u8, 116u8, 211u8, 151u8, 211u8, 92u8, 206u8,
            128u8, 235u8, 128u8, 229u8, 20u8, 8u8, 234u8, 215u8, 85u8, 251u8, 68u8, 110u8, 111u8,
            116u8, 76u8, 233u8, 142u8, 93u8, 240u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl Swap {
        const TOPIC_ID: [u8; 32] = [
            8u8, 116u8, 178u8, 213u8, 69u8, 203u8, 39u8, 28u8, 219u8, 218u8, 78u8, 9u8, 48u8, 32u8,
            196u8, 82u8, 50u8, 139u8, 36u8, 175u8, 18u8, 56u8, 46u8, 214u8, 44u8, 77u8, 0u8, 245u8,
            194u8, 103u8, 9u8, 219u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 4usize {
                return false;
    ...
    impl SwapFeePercentageChanged {
        const TOPIC_ID: [u8; 32] = [
            137u8, 212u8, 21u8, 34u8, 52u8, 47u8, 171u8, 172u8, 20u8, 113u8, 202u8, 96u8, 115u8,
            165u8, 98u8, 62u8, 92u8, 175u8, 54u8, 123u8, 3u8, 202u8, 110u8, 154u8, 0u8, 20u8,
            120u8, 208u8, 207u8, 139u8, 228u8, 161u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl Transfer {
        const TOPIC_ID: [u8; 32] = [
            209u8, 57u8, 139u8, 238u8, 25u8, 49u8, 61u8, 107u8, 246u8, 114u8, 204u8, 177u8, 22u8,
            229u8, 31u8, 74u8, 26u8, 148u8, 126u8, 145u8, 199u8, 87u8, 144u8, 127u8, 81u8, 251u8,
            181u8, 181u8, 229u8, 108u8, 105u8, 143u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 4usize {
                return false;
    ...
    impl Unwrap {
        const TOPIC_ID: [u8; 32] = [
            238u8, 183u8, 64u8, 201u8, 11u8, 242u8, 177u8, 140u8, 149u8, 50u8, 235u8, 125u8, 71u8,
            49u8, 55u8, 118u8, 112u8, 54u8, 216u8, 147u8, 223u8, 243u8, 224u8, 9u8, 243u8, 39u8,
            24u8, 248u8, 33u8, 178u8, 164u8, 192u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl VaultAuxiliary {
        const TOPIC_ID: [u8; 32] = [
            75u8, 196u8, 65u8, 46u8, 33u8, 1u8, 21u8, 69u8, 105u8, 3u8, 198u8, 91u8, 82u8, 119u8,
            210u8, 153u8, 165u8, 5u8, 231u8, 159u8, 46u8, 184u8, 82u8, 185u8, 43u8, 28u8, 165u8,
            45u8, 133u8, 133u8, 100u8, 40u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
    ...
    impl VaultBuffersPausedStateChanged {
        const TOPIC_ID: [u8; 32] = [
            48u8, 12u8, 124u8, 166u8, 25u8, 235u8, 132u8, 99u8, 134u8, 170u8, 10u8, 110u8, 89u8,
            22u8, 172u8, 42u8, 65u8, 64u8, 100u8, 72u8, 176u8, 162u8, 233u8, 155u8, 169u8, 204u8,
            175u8, 235u8, 137u8, 144u8, 21u8, 165u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl VaultPausedStateChanged {
        const TOPIC_ID: [u8; 32] = [
            224u8, 98u8, 159u8, 230u8, 86u8, 228u8, 90u8, 215u8, 253u8, 99u8, 162u8, 75u8, 137u8,
            157u8, 163u8, 104u8, 105u8, 0u8, 36u8, 192u8, 112u8, 67u8, 184u8, 142u8, 87u8, 174u8,
            229u8, 9u8, 91u8, 29u8, 61u8, 2u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl VaultQueriesDisabled {
        const TOPIC_ID: [u8; 32] = [
            189u8, 32u8, 64u8, 144u8, 253u8, 56u8, 127u8, 8u8, 227u8, 7u8, 101u8, 40u8, 191u8, 9u8,
            180u8, 252u8, 153u8, 216u8, 16u8, 13u8, 116u8, 158u8, 172u8, 233u8, 108u8, 6u8, 0u8,
            45u8, 63u8, 237u8, 198u8, 37u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl VaultQueriesEnabled {
        const TOPIC_ID: [u8; 32] = [
            145u8, 215u8, 71u8, 136u8, 53u8, 242u8, 181u8, 173u8, 195u8, 21u8, 245u8, 170u8, 217u8,
            32u8, 244u8, 167u8, 240u8, 160u8, 47u8, 127u8, 221u8, 243u8, 4u8, 45u8, 23u8, 178u8,
            200u8, 1u8, 104u8, 234u8, 23u8, 245u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl Wrap {
        const TOPIC_ID: [u8; 32] = [
            55u8, 113u8, 209u8, 60u8, 103u8, 1u8, 30u8, 49u8, 225u8, 32u8, 49u8, 197u8, 75u8,
            181u8, 155u8, 11u8, 245u8, 68u8, 168u8, 11u8, 129u8, 210u8, 128u8, 163u8, 113u8, 30u8,
            23u8, 42u8, 168u8, 183u8, 244u8, 123u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
