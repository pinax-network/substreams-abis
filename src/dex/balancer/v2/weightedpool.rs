...
pub mod functions {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetActualSupply {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetAthRateProduct {}
    impl GetAthRateProduct {
        const METHOD_ID: [u8; 4] = [35u8, 239u8, 137u8, 237u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for GetAthRateProduct {
        const NAME: &'static str = "getATHRateProduct";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetAthRateProduct {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetInvariant {}
    impl GetInvariant {
        const METHOD_ID: [u8; 4] = [192u8, 255u8, 26u8, 21u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for GetInvariant {
        const NAME: &'static str = "getInvariant";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetInvariant {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetLastPostJoinExitInvariant {}
    impl GetLastPostJoinExitInvariant {
        const METHOD_ID: [u8; 4] = [177u8, 9u8, 98u8, 120u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for GetLastPostJoinExitInvariant {
        const NAME: &'static str = "getLastPostJoinExitInvariant";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
        for GetLastPostJoinExitInvariant
    {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for GetProtocolSwapFeeDelegation {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<substreams::scalar::BigInt>> for GetScalingFactors {
        fn output(data: &[u8]) -> Result<Vec<substreams::scalar::BigInt>, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetSwapFeePercentage {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    pub struct OnSwap {
        ...
        pub balance_token_in: substreams::scalar::BigInt,
        pub balance_token_out: substreams::scalar::BigInt,
    }
    impl OnSwap {
        const METHOD_ID: [u8; 4] = [157u8, 44u8, 17u8, 12u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Tuple(vec![
                    ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                        match self.request.0.clone().to_bytes_be() {
                            (num_bigint::Sign::Plus, bytes) => bytes,
                            (num_bigint::Sign::NoSign, bytes) => bytes,
                            (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.request.1)),
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.request.2)),
                    ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                        match self.request.3.clone().to_bytes_be() {
                            (num_bigint::Sign::Plus, bytes) => bytes,
                            (num_bigint::Sign::NoSign, bytes) => bytes,
                            (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::FixedBytes(self.request.4.as_ref().to_vec()),
                    ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                        match self.request.5.clone().to_bytes_be() {
                            (num_bigint::Sign::Plus, bytes) => bytes,
                            (num_bigint::Sign::NoSign, bytes) => bytes,
                            (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.request.6)),
                    ethabi::Token::Address(ethabi::Address::from_slice(&self.request.7)),
                    ethabi::Token::Bytes(self.request.8.clone()),
                ]),
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.balance_token_in.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.balance_token_out.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
...
pub mod events {
    ...
    impl ProtocolFeePercentageCacheUpdated {
        const TOPIC_ID: [u8; 32] = [
            ...
            109u8, 96u8, 100u8, 190u8, 26u8, 233u8, 107u8, 253u8, 93u8, 46u8, 227u8, 92u8, 131u8,
            127u8, 208u8, 254u8, 12u8, 17u8, 149u8, 154u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl RecoveryModeStateChanged {
        const TOPIC_ID: [u8; 32] = [
            239u8, 243u8, 212u8, 210u8, 21u8, 180u8, 43u8, 240u8, 150u8, 11u8, 233u8, 198u8, 213u8,
            224u8, 92u8, 34u8, 203u8, 164u8, 223u8, 102u8, 39u8, 163u8, 165u8, 35u8, 226u8, 172u8,
            238u8, 115u8, 59u8, 88u8, 84u8, 200u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl SwapFeePercentageChanged {
        const TOPIC_ID: [u8; 32] = [
            169u8, 186u8, 63u8, 254u8, 11u8, 108u8, 54u8, 107u8, 129u8, 35u8, 44u8, 170u8, 179u8,
            134u8, 5u8, 160u8, 105u8, 154u8, 213u8, 57u8, 141u8, 108u8, 206u8, 118u8, 249u8, 30u8,
            232u8, 9u8, 227u8, 34u8, 218u8, 252u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
