...
pub mod events {
    ...
    pub struct TokenCreate {
        ...
        pub creator: Vec<u8>,
        pub nft_max_supply: substreams::scalar::BigInt,
        pub nft_threshold: substreams::scalar::BigInt,
        pub name: String,
        pub symbol: String,
    }
    impl TokenCreate {
        const TOPIC_ID: [u8; 32] = [
            22u8, 98u8, 77u8, 78u8, 7u8, 8u8, 85u8, 191u8, 79u8, 6u8, 224u8, 95u8, 15u8, 200u8,
            246u8, 9u8, 88u8, 251u8, 183u8, 252u8, 20u8, 51u8, 110u8, 29u8, 79u8, 148u8, 223u8,
            33u8, 14u8, 45u8, 88u8, 90u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
