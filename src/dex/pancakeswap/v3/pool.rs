    ...
    impl Swap {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                {
                    let non_full_signed_bytes = self.amount_specified.to_signed_bytes_be();
                    let full_signed_bytes_init = if non_full_signed_bytes[0] & 0x80 == 0x80 {
                        0xff
                    } else {
                        0x00
...
pub mod events {
    ...
    impl SetFeeProtocol {
        const TOPIC_ID: [u8; 32] = [
            179u8, 21u8, 159u8, 237u8, 61u8, 223u8, 186u8, 103u8, 186u8, 226u8, 148u8, 89u8, 158u8,
            175u8, 226u8, 208u8, 236u8, 152u8, 192u8, 139u8, 179u8, 142u8, 14u8, 95u8, 184u8,
            125u8, 51u8, 21u8, 75u8, 110u8, 5u8, 170u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl SetLmPoolEvent {
        const TOPIC_ID: [u8; 32] = [
            41u8, 152u8, 54u8, 144u8, 168u8, 90u8, 17u8, 105u8, 108u8, 232u8, 163u8, 87u8, 153u8,
            55u8, 68u8, 248u8, 213u8, 167u8, 79u8, 222u8, 20u8, 101u8, 62u8, 81u8, 124u8, 194u8,
            248u8, 96u8, 138u8, 114u8, 53u8, 233u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl Swap {
        const TOPIC_ID: [u8; 32] = [
            25u8, 180u8, 114u8, 121u8, 37u8, 107u8, 42u8, 35u8, 161u8, 102u8, 92u8, 129u8, 12u8,
            141u8, 85u8, 161u8, 117u8, 137u8, 64u8, 238u8, 9u8, 55u8, 125u8, 79u8, 141u8, 38u8,
            73u8, 122u8, 53u8, 119u8, 220u8, 131u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
