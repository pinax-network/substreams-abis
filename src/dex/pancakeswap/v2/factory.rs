...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct InitCodePairHash {}
    impl InitCodePairHash {
        const METHOD_ID: [u8; 4] = [88u8, 85u8, 162u8, 90u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for InitCodePairHash {
        const NAME: &'static str = "INIT_CODE_PAIR_HASH";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for InitCodePairHash {
