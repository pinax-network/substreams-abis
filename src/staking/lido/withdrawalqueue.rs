...
pub mod functions {
    ...
    pub struct CalculateFinalizationBatches {
        pub max_share_rate: substreams::scalar::BigInt,
        pub max_timestamp: substreams::scalar::BigInt,
        pub max_requests_per_call: substreams::scalar::BigInt,
        pub state: (
    ...
    impl CalculateFinalizationBatches {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.max_share_rate.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.max_requests_per_call.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Tuple(vec![
                    ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                        match self.state.0.clone().to_bytes_be() {
                            (num_bigint::Sign::Plus, bytes) => bytes,
                            (num_bigint::Sign::NoSign, bytes) => bytes,
                            (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Bool(self.state.1.clone()),
                    {
                        let v = self
                            .state
                            .2
                    ...
                    ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                        match self.state.3.clone().to_bytes_be() {
                            (num_bigint::Sign::Plus, bytes) => bytes,
                            (num_bigint::Sign::NoSign, bytes) => bytes,
                            (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported")
    ...
    pub struct ClaimWithdrawals {
        pub request_ids: Vec<substreams::scalar::BigInt>,
        pub hints: Vec<substreams::scalar::BigInt>,
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct Finalize {
        pub last_request_id_to_be_finalized: substreams::scalar::BigInt,
        pub max_share_rate: substreams::scalar::BigInt,
    }
    impl Finalize {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            values.reverse();
            Ok(Self {
                last_request_id_to_be_finalized: {
                    let mut v = [0 as u8; 32];
                    values
                        .pop()
                        .expect(INTERNAL_ERR)
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.last_request_id_to_be_finalized.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
    ...
    pub struct FindCheckpointHints {
        pub request_ids: Vec<substreams::scalar::BigInt>,
        pub first_index: substreams::scalar::BigInt,
        pub last_index: substreams::scalar::BigInt,
    }
    impl FindCheckpointHints {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.first_index.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.last_index.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<substreams::scalar::BigInt>> for GetClaimableEther {
        fn output(data: &[u8]) -> Result<Vec<substreams::scalar::BigInt>, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetLastCheckpointIndex {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetLastRequestId {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetLockedEtherAmount {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MaxBatchesLength {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    pub struct OnOracleReport {
        pub is_bunker_mode_now: bool,
        pub bunker_start_timestamp: substreams::scalar::BigInt,
        pub current_report_timestamp: substreams::scalar::BigInt,
    }
    impl OnOracleReport {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            values.reverse();
            Ok(Self {
                is_bunker_mode_now: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_bool()
                    .expect(INTERNAL_ERR),
                bunker_start_timestamp: {
                    let mut v = [0 as u8; 32];
                    values
                        .pop()
                        .expect(INTERNAL_ERR)
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Bool(self.is_bunker_mode_now.clone()),
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.bunker_start_timestamp.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.current_report_timestamp.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for PauseInfinitely {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    pub struct PauseUntil {
        pub pause_until_inclusive: substreams::scalar::BigInt,
    }
    impl PauseUntil {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                match self.pause_until_inclusive.clone().to_bytes_be() {
                    (num_bigint::Sign::Plus, bytes) => bytes,
                    (num_bigint::Sign::NoSign, bytes) => bytes,
                    (num_bigint::Sign::Minus, _) => {
                        panic!("negative numbers are not supported")
    ...
    pub struct Prefinalize {
        pub batches: Vec<substreams::scalar::BigInt>,
        pub max_share_rate: substreams::scalar::BigInt,
    }
    impl Prefinalize {
    ...
    impl RequestWithdrawalsWithPermit {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Tuple(vec![
                    ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                        match self.permit.0.clone().to_bytes_be() {
                            (num_bigint::Sign::Plus, bytes) => bytes,
                            (num_bigint::Sign::NoSign, bytes) => bytes,
                            (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                        match self.permit.1.clone().to_bytes_be() {
                            (num_bigint::Sign::Plus, bytes) => bytes,
                            (num_bigint::Sign::NoSign, bytes) => bytes,
                            (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                        match self.permit.2.clone().to_bytes_be() {
                            (num_bigint::Sign::Plus, bytes) => bytes,
                            (num_bigint::Sign::NoSign, bytes) => bytes,
                            (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::FixedBytes(self.permit.3.as_ref().to_vec()),
                    ethabi::Token::FixedBytes(self.permit.4.as_ref().to_vec()),
                ]),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for UnfinalizedStEth {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    impl BaseUriSet {
        const TOPIC_ID: [u8; 32] = [
            249u8, 199u8, 128u8, 62u8, 148u8, 224u8, 211u8, 192u8, 41u8, 0u8, 216u8, 169u8, 8u8,
            147u8, 166u8, 213u8, 233u8, 13u8, 208u8, 77u8, 50u8, 164u8, 207u8, 232u8, 37u8, 82u8,
            15u8, 130u8, 191u8, 159u8, 50u8, 246u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl BatchMetadataUpdate {
        const TOPIC_ID: [u8; 32] = [
            107u8, 213u8, 201u8, 80u8, 168u8, 216u8, 223u8, 23u8, 247u8, 114u8, 245u8, 175u8, 55u8,
            203u8, 54u8, 85u8, 115u8, 120u8, 153u8, 203u8, 249u8, 3u8, 38u8, 75u8, 151u8, 149u8,
            89u8, 45u8, 164u8, 57u8, 102u8, 28u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl BunkerModeDisabled {
        const TOPIC_ID: [u8; 32] = [
            209u8, 248u8, 162u8, 153u8, 140u8, 12u8, 175u8, 115u8, 224u8, 148u8, 52u8, 170u8,
            147u8, 210u8, 115u8, 165u8, 153u8, 6u8, 13u8, 120u8, 148u8, 7u8, 198u8, 247u8, 12u8,
            205u8, 76u8, 156u8, 159u8, 50u8, 200u8, 244u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    pub struct BunkerModeEnabled {
        pub since_timestamp: substreams::scalar::BigInt,
    }
    impl BunkerModeEnabled {
        const TOPIC_ID: [u8; 32] = [
            71u8, 240u8, 59u8, 7u8, 229u8, 181u8, 55u8, 127u8, 135u8, 21u8, 57u8, 187u8, 41u8,
            66u8, 245u8, 236u8, 183u8, 39u8, 51u8, 190u8, 159u8, 201u8, 213u8, 90u8, 23u8, 182u8,
            214u8, 160u8, 93u8, 65u8, 131u8, 69u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl InitializedV1 {
        const TOPIC_ID: [u8; 32] = [
            32u8, 179u8, 77u8, 42u8, 170u8, 246u8, 172u8, 180u8, 251u8, 188u8, 156u8, 72u8, 70u8,
            133u8, 139u8, 184u8, 36u8, 5u8, 58u8, 177u8, 31u8, 244u8, 74u8, 89u8, 223u8, 186u8,
            30u8, 34u8, 206u8, 184u8, 165u8, 9u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl MetadataUpdate {
        const TOPIC_ID: [u8; 32] = [
            ...
            241u8, 164u8, 253u8, 233u8, 142u8, 225u8, 122u8, 227u8, 69u8, 203u8, 95u8, 107u8, 94u8,
            44u8, 39u8, 245u8, 3u8, 62u8, 140u8, 231u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl NftDescriptorAddressSet {
        const TOPIC_ID: [u8; 32] = [
            78u8, 192u8, 74u8, 199u8, 28u8, 73u8, 238u8, 160u8, 169u8, 77u8, 197u8, 150u8, 123u8,
            73u8, 52u8, 18u8, 168u8, 205u8, 178u8, 147u8, 75u8, 54u8, 119u8, 19u8, 1u8, 157u8,
            59u8, 17u8, 14u8, 159u8, 11u8, 168u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl Paused {
        const TOPIC_ID: [u8; 32] = [
            50u8, 251u8, 124u8, 152u8, 145u8, 188u8, 79u8, 150u8, 60u8, 125u8, 233u8, 241u8, 24u8,
            109u8, 42u8, 119u8, 85u8, 199u8, 214u8, 233u8, 244u8, 96u8, 77u8, 171u8, 225u8, 216u8,
            187u8, 48u8, 39u8, 194u8, 244u8, 158u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl WithdrawalClaimed {
        const TOPIC_ID: [u8; 32] = [
            106u8, 210u8, 108u8, 94u8, 35u8, 142u8, 125u8, 0u8, 39u8, 153u8, 249u8, 165u8, 219u8,
            7u8, 232u8, 30u8, 241u8, 78u8, 55u8, 56u8, 106u8, 224u8, 52u8, 150u8, 215u8, 167u8,
            239u8, 4u8, 113u8, 62u8, 20u8, 91u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 4usize {
                return false;
    ...
    impl WithdrawalRequested {
        const TOPIC_ID: [u8; 32] = [
            240u8, 203u8, 71u8, 31u8, 35u8, 251u8, 116u8, 234u8, 68u8, 184u8, 37u8, 46u8, 177u8,
            136u8, 26u8, 45u8, 202u8, 84u8, 98u8, 136u8, 217u8, 246u8, 233u8, 13u8, 26u8, 14u8,
            130u8, 254u8, 14u8, 211u8, 66u8, 171u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 4usize {
                return false;
    ...
    impl WithdrawalsFinalized {
        const TOPIC_ID: [u8; 32] = [
            25u8, 120u8, 116u8, 199u8, 42u8, 246u8, 160u8, 111u8, 176u8, 170u8, 79u8, 171u8, 69u8,
            253u8, 57u8, 199u8, 203u8, 97u8, 172u8, 9u8, 146u8, 21u8, 152u8, 114u8, 220u8, 50u8,
            149u8, 32u8, 125u8, 167u8, 233u8, 235u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
