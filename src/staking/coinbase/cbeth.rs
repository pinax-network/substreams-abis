...
pub mod functions {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for ExchangeRate {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::Function for ReceiveWithAuthorization {
    ...
    pub struct UpdateExchangeRate {
        pub new_exchange_rate: substreams::scalar::BigInt,
    }
    impl UpdateExchangeRate {
        const METHOD_ID: [u8; 4] = [185u8, 226u8, 5u8, 174u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                match self.new_exchange_rate.clone().to_bytes_be() {
                    (num_bigint::Sign::Plus, bytes) => bytes,
                    (num_bigint::Sign::NoSign, bytes) => bytes,
                    (num_bigint::Sign::Minus, _) => {
                        panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::Function for UpdateExchangeRate {
        const NAME: &'static str = "updateExchangeRate";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl UpdateOracle {
        const METHOD_ID: [u8; 4] = [28u8, 180u8, 77u8, 252u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for UpdateOracle {
        const NAME: &'static str = "updateOracle";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
...
pub mod events {
    ...
    impl ExchangeRateUpdated {
        const TOPIC_ID: [u8; 32] = [
            11u8, 78u8, 147u8, 144u8, 5u8, 67u8, 71u8, 226u8, 161u8, 109u8, 149u8, 253u8, 131u8,
            118u8, 49u8, 27u8, 13u8, 45u8, 238u8, 222u8, 203u8, 165u8, 38u8, 233u8, 116u8, 43u8,
            202u8, 164u8, 11u8, 5u8, 159u8, 11u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl OracleUpdated {
        const TOPIC_ID: [u8; 32] = [
            61u8, 247u8, 123u8, 235u8, 93u8, 176u8, 95u8, 205u8, 215u8, 10u8, 48u8, 252u8, 138u8,
            223u8, 63u8, 131u8, 249u8, 80u8, 27u8, 104u8, 87u8, 148u8, 85u8, 173u8, 189u8, 16u8,
            11u8, 129u8, 128u8, 148u8, 3u8, 148u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
