...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct MaxHoldingAmount {}
    impl MaxHoldingAmount {
        const METHOD_ID: [u8; 4] = [137u8, 249u8, 161u8, 211u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for MaxHoldingAmount {
        const NAME: &'static str = "maxHoldingAmount";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for MaxHoldingAmount {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct MinHoldingAmount {}
    impl MinHoldingAmount {
        const METHOD_ID: [u8; 4] = [26u8, 185u8, 158u8, 18u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for MinHoldingAmount {
        const NAME: &'static str = "minHoldingAmount";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    pub struct SetRule {
        pub limited: bool,
        pub uniswap_v2_pair: Vec<u8>,
        pub max_holding_amount: substreams::scalar::BigInt,
        pub min_holding_amount: substreams::scalar::BigInt,
    }
    impl SetRule {
        const METHOD_ID: [u8; 4] = [58u8, 166u8, 51u8, 170u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Bool(self.limited.clone()),
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.uniswap_v2_pair),
                    ),
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.max_holding_amount.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
                    ...
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.min_holding_amount.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::Function for SetRule {
        const NAME: &'static str = "setRule";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
