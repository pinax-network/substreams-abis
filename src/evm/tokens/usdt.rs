    ...
    impl AddBlackList {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[ethabi::Token::Address(ethabi::Address::from_slice(&self.evil_user))],
            );
            ...
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.upgraded_address),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    impl DestroyBlackFunds {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.black_listed_user),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
    ...
    impl RemoveBlackList {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Address(
                        ethabi::Address::from_slice(&self.cleared_user),
                    ),
                ],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
