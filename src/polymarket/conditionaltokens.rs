...
pub mod functions {
    ...
    impl GetCollectionId {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::FixedBytes(self.parent_collection_id.as_ref().to_vec()),
    ...
    impl GetOutcomeSlotCount {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::FixedBytes(
                self.condition_id.as_ref().to_vec(),
            )]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetOutcomeSlotCount {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for PayoutDenominator {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for PayoutNumerators {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    impl ConditionPreparation {
        const TOPIC_ID: [u8; 32] = [
            171u8, 55u8, 96u8, 195u8, 189u8, 43u8, 179u8, 139u8, 91u8, 207u8, 84u8, 220u8, 121u8,
            128u8, 46u8, 214u8, 115u8, 56u8, 180u8, 207u8, 41u8, 243u8, 5u8, 77u8, 237u8, 103u8,
            237u8, 36u8, 102u8, 30u8, 65u8, 119u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl ConditionResolution {
        const TOPIC_ID: [u8; 32] = [
            180u8, 77u8, 132u8, 211u8, 40u8, 150u8, 145u8, 247u8, 20u8, 151u8, 86u8, 75u8, 133u8,
            212u8, 35u8, 54u8, 72u8, 217u8, 219u8, 174u8, 140u8, 189u8, 187u8, 67u8, 41u8, 243u8,
            1u8, 195u8, 160u8, 24u8, 88u8, 148u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 4usize {
                return false;
    ...
    impl PositionSplit {
        const TOPIC_ID: [u8; 32] = [
            46u8, 107u8, 185u8, 31u8, 140u8, 188u8, 218u8, 12u8, 147u8, 98u8, 60u8, 84u8, 208u8,
            64u8, 58u8, 67u8, 81u8, 79u8, 171u8, 196u8, 0u8, 132u8, 236u8, 150u8, 182u8, 213u8,
            55u8, 154u8, 116u8, 120u8, 98u8, 152u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 4usize {
                return false;
