...
pub mod functions {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for Claim {
        fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct ClaimForAddr {
        pub addr: Vec<u8>,
        pub owner: Vec<u8>,
        pub resolver: Vec<u8>,
    }
    impl ClaimForAddr {
        const METHOD_ID: [u8; 4] = [101u8, 102u8, 150u8, 49u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for ClaimForAddr {
        const NAME: &'static str = "claimForAddr";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for ClaimForAddr {
        fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct ClaimWithResolver {
        pub owner: Vec<u8>,
        pub resolver: Vec<u8>,
    }
    impl ClaimWithResolver {
        const METHOD_ID: [u8; 4] = [15u8, 90u8, 84u8, 102u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for ClaimWithResolver {
        const NAME: &'static str = "claimWithResolver";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for ClaimWithResolver {
        fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            Self::output(data)
        }
    }
    ...
    impl DefaultResolver {
        const METHOD_ID: [u8; 4] = [130u8, 142u8, 171u8, 14u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for DefaultResolver {
        const NAME: &'static str = "defaultResolver";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for DefaultResolver {
    ...
    impl Node {
        const METHOD_ID: [u8; 4] = [191u8, 251u8, 230u8, 28u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for Node {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for Node {
        fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetDefaultResolver {
        pub resolver: Vec<u8>,
    }
    impl SetDefaultResolver {
        const METHOD_ID: [u8; 4] = [198u8, 100u8, 133u8, 178u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for SetDefaultResolver {
        const NAME: &'static str = "setDefaultResolver";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for SetName {
        fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetNameForAddr {
        pub addr: Vec<u8>,
        pub owner: Vec<u8>,
        pub resolver: Vec<u8>,
        pub name: String,
    ...
    impl SetNameForAddr {
        const METHOD_ID: [u8; 4] = [122u8, 128u8, 109u8, 107u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for SetNameForAddr {
        const NAME: &'static str = "setNameForAddr";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for SetNameForAddr {
        fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct DefaultResolverChanged {
        pub resolver: Vec<u8>,
    }
    impl DefaultResolverChanged {
        const TOPIC_ID: [u8; 32] = [
            234u8, 225u8, 122u8, 132u8, 217u8, 235u8, 131u8, 216u8, 200u8, 235u8, 49u8, 127u8,
            158u8, 125u8, 100u8, 133u8, 123u8, 195u8, 99u8, 250u8, 81u8, 103u8, 77u8, 153u8, 108u8,
            2u8, 63u8, 67u8, 64u8, 197u8, 119u8, 207u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            Ok(Self {
                resolver: ethabi::decode(
                    &[ethabi::ParamType::Address],
                    log.topics[1usize].as_ref(),
                )
                .map_err(|e| {
                    format!(
                        "unable to decode param 'resolver' from topic of type 'address': {:?}",
                        e
                    )
                })?
                .pop()
    ...
    impl substreams_ethereum::Event for DefaultResolverChanged {
        const NAME: &'static str = "DefaultResolverChanged";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl ReverseClaimed {
        const TOPIC_ID: [u8; 32] = [
            106u8, 218u8, 134u8, 141u8, 211u8, 5u8, 140u8, 247u8, 122u8, 72u8, 167u8, 68u8, 137u8,
            253u8, 121u8, 99u8, 104u8, 142u8, 84u8, 100u8, 178u8, 176u8, 250u8, 149u8, 122u8,
            206u8, 151u8, 98u8, 67u8, 39u8, 14u8, 146u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            Ok(Self {
                addr: ethabi::decode(&[ethabi::ParamType::Address], log.topics[1usize].as_ref())
                    .map_err(|e| {
                        format!(
    ...
    impl substreams_ethereum::Event for ReverseClaimed {
