...
pub mod functions {
    ...
    impl substreams_ethereum::Function for ActivateTstore {
        const NAME: &'static str = "__activateTstore";
    ...
    impl substreams_ethereum::Function for FulfillBasicOrder {
        const NAME: &'static str = "fulfillBasicOrder";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for FulfillBasicOrder {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    #[derive(Clone)]
    pub struct FulfillBasicOrderEfficient6gl6yc {
        pub param0: (
            Vec<u8>,
            substreams::scalar::BigInt,
            substreams::scalar::BigInt,
    ...
    impl substreams_ethereum::Function for FulfillBasicOrderEfficient6gl6yc {
        const NAME: &'static str = "fulfillBasicOrder_efficient_6GL6yc";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::Function for FulfillOrder {
        const NAME: &'static str = "fulfillOrder";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for FulfillOrder {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
