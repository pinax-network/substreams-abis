...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct AtokenRevision {}
    impl AtokenRevision {
        const METHOD_ID: [u8; 4] = [11u8, 215u8, 173u8, 59u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for AtokenRevision {
        const NAME: &'static str = "ATOKEN_REVISION";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for AtokenRevision {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    pub struct Burn {
        pub from: Vec<u8>,
        pub receiver_of_underlying: Vec<u8>,
        pub amount: substreams::scalar::BigInt,
        pub scaled_amount: substreams::scalar::BigInt,
        pub index: substreams::scalar::BigInt,
    }
    impl Burn {
        const METHOD_ID: [u8; 4] = [177u8, 141u8, 106u8, 253u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Address(ethabi::Address::from_slice(&self.receiver_of_underlying)),
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.amount.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
    ...
    pub struct Initialize {
        ...
        pub a_token_decimals: substreams::scalar::BigInt,
        pub a_token_name: String,
        pub a_token_symbol: String,
        pub params: Vec<u8>,
    }
    impl Initialize {
        const METHOD_ID: [u8; 4] = [127u8, 221u8, 88u8, 95u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.a_token_decimals.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
                        (num_bigint::Sign::Minus, _) => {
                            panic!("negative numbers are not supported")
                ...
                ethabi::Token::String(self.a_token_name.clone()),
                ethabi::Token::String(self.a_token_symbol.clone()),
    ...
    impl MintToTreasury {
        const METHOD_ID: [u8; 4] = [125u8, 245u8, 189u8, 59u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RenounceAllowance {
        pub owner: Vec<u8>,
    }
    impl RenounceAllowance {
        const METHOD_ID: [u8; 4] = [175u8, 95u8, 36u8, 59u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for RenounceAllowance {
        const NAME: &'static str = "renounceAllowance";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ReserveTreasuryAddress {}
    impl ReserveTreasuryAddress {
        const METHOD_ID: [u8; 4] = [174u8, 22u8, 115u8, 53u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for ReserveTreasuryAddress {
        const NAME: &'static str = "RESERVE_TREASURY_ADDRESS";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for ReserveTreasuryAddress {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    impl RewardsController {
        const METHOD_ID: [u8; 4] = [205u8, 8u8, 109u8, 69u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for RewardsController {
        const NAME: &'static str = "REWARDS_CONTROLLER";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for RewardsController {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct TransferOnLiquidation {
        pub from: Vec<u8>,
        pub to: Vec<u8>,
        pub amount: substreams::scalar::BigInt,
        pub scaled_amount: substreams::scalar::BigInt,
    ...
    impl TransferOnLiquidation {
        const METHOD_ID: [u8; 4] = [53u8, 59u8, 123u8, 154u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for TransferOnLiquidation {
        const NAME: &'static str = "transferOnLiquidation";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct TransferUnderlyingTo {
        pub target: Vec<u8>,
        pub amount: substreams::scalar::BigInt,
    }
    impl TransferUnderlyingTo {
        const METHOD_ID: [u8; 4] = [78u8, 254u8, 202u8, 165u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for TransferUnderlyingTo {
        const NAME: &'static str = "transferUnderlyingTo";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    pub struct Treasury {}
    impl Treasury {
        const METHOD_ID: [u8; 4] = [45u8, 44u8, 85u8, 101u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
...
pub mod events {
    ...
    impl BalanceTransfer {
        const TOPIC_ID: [u8; 32] = [
            75u8, 236u8, 203u8, 144u8, 249u8, 148u8, 195u8, 26u8, 206u8, 215u8, 162u8, 59u8, 86u8,
            17u8, 2u8, 7u8, 40u8, 162u8, 61u8, 142u8, 197u8, 205u8, 221u8, 26u8, 62u8, 157u8,
            151u8, 185u8, 111u8, 218u8, 134u8, 102u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
    ...
    impl substreams_ethereum::Event for BalanceTransfer {
        const NAME: &'static str = "BalanceTransfer";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl Initialized {
        const TOPIC_ID: [u8; 32] = [
            177u8, 158u8, 5u8, 31u8, 138u8, 244u8, 17u8, 80u8, 204u8, 204u8, 179u8, 252u8, 44u8,
            45u8, 141u8, 21u8, 244u8, 164u8, 207u8, 67u8, 79u8, 50u8, 165u8, 89u8, 186u8, 117u8,
            254u8, 115u8, 214u8, 238u8, 162u8, 11u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
