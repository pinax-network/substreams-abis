...
pub mod functions {
    ...
    impl NegRiskAdapter {
        const METHOD_ID: [u8; 4] = [246u8, 248u8, 138u8, 141u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for NegRiskAdapter {
        const NAME: &'static str = "NEG_RISK_ADAPTER";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for NegRiskAdapter {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct WrappedCollateral {}
    impl WrappedCollateral {
        const METHOD_ID: [u8; 4] = [45u8, 39u8, 114u8, 96u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for WrappedCollateral {
        const NAME: &'static str = "WRAPPED_COLLATERAL";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for WrappedCollateral {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
