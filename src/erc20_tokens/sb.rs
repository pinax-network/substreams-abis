...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct BurnFrom1 {
        pub account: Vec<u8>,
        pub amount: substreams::scalar::BigInt,
    }
    impl BurnFrom1 {
        const METHOD_ID: [u8; 4] = [162u8, 43u8, 53u8, 206u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for BurnFrom1 {
        const NAME: &'static str = "_burnFrom";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::Function for BurnFrom2 {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for SetVault {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
