...
pub mod events {
    ...
    impl MinterChanged {
        const TOPIC_ID: [u8; 32] = [
            59u8, 0u8, 7u8, 235u8, 148u8, 28u8, 246u8, 69u8, 82u8, 108u8, 187u8, 58u8, 79u8, 218u8,
            236u8, 218u8, 157u8, 40u8, 206u8, 72u8, 67u8, 22u8, 125u8, 146u8, 99u8, 181u8, 54u8,
            161u8, 241u8, 237u8, 192u8, 246u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
