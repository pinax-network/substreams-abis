...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct DstContractLookup {
        pub param0: substreams::scalar::BigInt,
    }
    impl DstContractLookup {
        const METHOD_ID: [u8; 4] = [96u8, 240u8, 92u8, 122u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for DstContractLookup {
        const NAME: &'static str = "dstContractLookup";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for DstContractLookup {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct EstimateSendTokensFee {
        pub dst_chain_id: substreams::scalar::BigInt,
        pub use_zro: bool,
        pub tx_parameters: Vec<u8>,
    }
    impl EstimateSendTokensFee {
        const METHOD_ID: [u8; 4] = [115u8, 135u8, 67u8, 54u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Bool(self.use_zro.clone()),
                ethabi::Token::Bytes(self.tx_parameters.clone()),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl substreams_ethereum::Function for EstimateSendTokensFee {
        const NAME: &'static str = "estimateSendTokensFee";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    pub struct IsMain {}
    impl IsMain {
        const METHOD_ID: [u8; 4] = [96u8, 66u8, 105u8, 209u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for IsMain {
        const NAME: &'static str = "isMain";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for IsMain {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    impl LzReceive {
        const METHOD_ID: [u8; 4] = [0u8, 29u8, 53u8, 103u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Bytes(self.from_address.clone()),
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct PauseSendTokens {
        pub pause: bool,
    }
    impl PauseSendTokens {
        const METHOD_ID: [u8; 4] = [241u8, 135u8, 137u8, 34u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for PauseSendTokens {
        const NAME: &'static str = "pauseSendTokens";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    pub struct SendTokens {
        ...
        pub adapter_param: Vec<u8>,
    }
    impl SendTokens {
        const METHOD_ID: [u8; 4] = [46u8, 21u8, 35u8, 140u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Address(ethabi::Address::from_slice(&self.zro_payment_address)),
                ethabi::Token::Bytes(self.adapter_param.clone()),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl SetDestination {
        const METHOD_ID: [u8; 4] = [112u8, 109u8, 143u8, 255u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
            ...
            Ok(Self {
                ...
                destination_contract_address: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_bytes()
                    .expect(INTERNAL_ERR),
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Bytes(self.destination_contract_address.clone()),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl substreams_ethereum::Function for SetDestination {
...
pub mod events {
    ...
    impl Paused {
        const TOPIC_ID: [u8; 32] = [
            14u8, 47u8, 176u8, 49u8, 238u8, 3u8, 45u8, 192u8, 45u8, 128u8, 17u8, 220u8, 80u8,
            184u8, 22u8, 235u8, 69u8, 12u8, 248u8, 86u8, 171u8, 216u8, 38u8, 22u8, 128u8, 218u8,
            199u8, 79u8, 114u8, 22u8, 91u8, 210u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ReceiveFromChain {
        pub src_chain_id: substreams::scalar::BigInt,
        pub nonce: substreams::scalar::BigInt,
        pub qty: substreams::scalar::BigInt,
    }
    impl ReceiveFromChain {
        const TOPIC_ID: [u8; 32] = [
            131u8, 27u8, 198u8, 130u8, 38u8, 248u8, 209u8, 247u8, 52u8, 255u8, 204u8, 167u8, 54u8,
            2u8, 239u8, 196u8, 236u8, 161u8, 55u8, 17u8, 64u8, 43u8, 161u8, 210u8, 204u8, 5u8,
            238u8, 23u8, 187u8, 84u8, 246u8, 49u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl substreams_ethereum::Event for ReceiveFromChain {
        const NAME: &'static str = "ReceiveFromChain";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl SendToChain {
        const TOPIC_ID: [u8; 32] = [
            102u8, 78u8, 38u8, 121u8, 124u8, 222u8, 17u8, 70u8, 221u8, 252u8, 185u8, 165u8, 211u8,
            244u8, 222u8, 97u8, 23u8, 159u8, 156u8, 17u8, 178u8, 105u8, 133u8, 153u8, 187u8, 9u8,
            230u8, 134u8, 244u8, 66u8, 23u8, 43u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl substreams_ethereum::Event for SendToChain {
        const NAME: &'static str = "SendToChain";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
