...
pub mod events {
    ...
    impl PauserAdded {
        const TOPIC_ID: [u8; 32] = [
            103u8, 25u8, 208u8, 140u8, 24u8, 136u8, 16u8, 59u8, 234u8, 37u8, 26u8, 78u8, 213u8,
            100u8, 6u8, 189u8, 12u8, 62u8, 105u8, 114u8, 60u8, 138u8, 22u8, 134u8, 224u8, 23u8,
            231u8, 187u8, 225u8, 89u8, 182u8, 248u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl PauserRemoved {
        const TOPIC_ID: [u8; 32] = [
            205u8, 38u8, 94u8, 186u8, 240u8, 157u8, 242u8, 135u8, 28u8, 199u8, 189u8, 65u8, 51u8,
            64u8, 74u8, 35u8, 91u8, 161u8, 46u8, 255u8, 32u8, 65u8, 187u8, 137u8, 217u8, 199u8,
            20u8, 162u8, 98u8, 28u8, 124u8, 126u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
