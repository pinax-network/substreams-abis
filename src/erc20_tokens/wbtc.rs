...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct FinishMinting {}
    impl FinishMinting {
        const METHOD_ID: [u8; 4] = [125u8, 100u8, 188u8, 180u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for FinishMinting {
        const NAME: &'static str = "finishMinting";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for FinishMinting {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    impl MintingFinished {
        const METHOD_ID: [u8; 4] = [5u8, 210u8, 3u8, 91u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for MintingFinished {
        const NAME: &'static str = "mintingFinished";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for MintingFinished {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    ...
    impl ReclaimToken {
        const METHOD_ID: [u8; 4] = [23u8, 255u8, 195u8, 32u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for ReclaimToken {
        const NAME: &'static str = "reclaimToken";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
...
pub mod events {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct MintFinished {}
    impl MintFinished {
        const TOPIC_ID: [u8; 32] = [
            174u8, 81u8, 132u8, 251u8, 168u8, 50u8, 203u8, 43u8, 31u8, 112u8, 42u8, 202u8, 97u8,
            23u8, 184u8, 210u8, 101u8, 234u8, 240u8, 58u8, 211u8, 62u8, 177u8, 51u8, 241u8, 157u8,
            222u8, 15u8, 89u8, 32u8, 250u8, 8u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl substreams_ethereum::Event for MintFinished {
        const NAME: &'static str = "MintFinished";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    impl OwnershipRenounced {
        const TOPIC_ID: [u8; 32] = [
            248u8, 223u8, 49u8, 20u8, 77u8, 156u8, 47u8, 15u8, 107u8, 89u8, 214u8, 155u8, 139u8,
            152u8, 171u8, 213u8, 69u8, 157u8, 7u8, 242u8, 116u8, 44u8, 77u8, 249u8, 32u8, 178u8,
            90u8, 174u8, 51u8, 198u8, 72u8, 32u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl substreams_ethereum::Event for OwnershipRenounced {
        const NAME: &'static str = "OwnershipRenounced";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
