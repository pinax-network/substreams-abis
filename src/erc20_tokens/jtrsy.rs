...
pub mod functions {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for DeploymentChainId {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl HookDataOf {
        ...
        pub fn output(data: &[u8]) -> Result<[u8; 16usize], String> {
            let mut values =
                ethabi::decode(&[ethabi::ParamType::FixedBytes(16usize)], data.as_ref())
                    .map_err(|e| format!("unable to decode output data: {:?}", e))?;
            Ok({
    ...
    impl substreams_ethereum::rpc::RPCDecodable<String> for MessageForTransferRestriction {
...
pub mod events {
    ...
    impl Deny {
        const TOPIC_ID: [u8; 32] = [
            24u8, 68u8, 80u8, 223u8, 46u8, 50u8, 58u8, 206u8, 192u8, 237u8, 59u8, 92u8, 117u8,
            49u8, 184u8, 31u8, 155u8, 76u8, 222u8, 247u8, 145u8, 77u8, 253u8, 76u8, 10u8, 67u8,
            23u8, 65u8, 107u8, 181u8, 37u8, 27u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl File1 {
        const TOPIC_ID: [u8; 32] = [
            228u8, 46u8, 11u8, 154u8, 2u8, 157u8, 200u8, 124u8, 203u8, 16u8, 41u8, 198u8, 50u8,
            230u8, 53u8, 144u8, 144u8, 172u8, 208u8, 235u8, 3u8, 43u8, 43u8, 89u8, 200u8, 17u8,
            227u8, 236u8, 112u8, 22u8, 13u8, 198u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl File2 {
        const TOPIC_ID: [u8; 32] = [
            143u8, 239u8, 88u8, 139u8, 95u8, 193u8, 175u8, 191u8, 91u8, 47u8, 6u8, 193u8, 164u8,
            53u8, 213u8, 19u8, 242u8, 8u8, 218u8, 46u8, 103u8, 4u8, 195u8, 216u8, 240u8, 224u8,
            236u8, 145u8, 22u8, 112u8, 102u8, 186u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl Rely {
        const TOPIC_ID: [u8; 32] = [
            221u8, 14u8, 52u8, 3u8, 138u8, 195u8, 139u8, 42u8, 28u8, 233u8, 96u8, 34u8, 151u8,
            120u8, 172u8, 72u8, 168u8, 113u8, 155u8, 201u8, 0u8, 182u8, 196u8, 248u8, 208u8, 71u8,
            92u8, 110u8, 139u8, 56u8, 90u8, 96u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl SetHookData {
        const TOPIC_ID: [u8; 32] = [
            143u8, 162u8, 153u8, 72u8, 224u8, 168u8, 78u8, 60u8, 115u8, 141u8, 46u8, 146u8, 30u8,
            101u8, 250u8, 182u8, 229u8, 160u8, 34u8, 145u8, 254u8, 137u8, 143u8, 217u8, 77u8, 96u8,
            195u8, 200u8, 238u8, 97u8, 76u8, 69u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            let mut values =
                ethabi::decode(&[ethabi::ParamType::FixedBytes(16usize)], log.data.as_ref())
                    .map_err(|e| format!("unable to decode log.data: {:?}", e))?;
            values.reverse();
            Ok(Self {
                user: ethabi::decode(&[ethabi::ParamType::Address], log.topics[1usize].as_ref())
    ...
    impl VaultUpdate {
        const TOPIC_ID: [u8; 32] = [
            216u8, 198u8, 184u8, 246u8, 202u8, 73u8, 119u8, 19u8, 123u8, 208u8, 192u8, 95u8, 142u8,
            73u8, 9u8, 158u8, 11u8, 187u8, 239u8, 229u8, 237u8, 48u8, 16u8, 191u8, 130u8, 138u8,
            118u8, 219u8, 171u8, 149u8, 131u8, 19u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
