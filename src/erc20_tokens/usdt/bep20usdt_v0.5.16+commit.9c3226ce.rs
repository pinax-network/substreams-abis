...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct Decimals1 {}
    impl Decimals1 {
        const METHOD_ID: [u8; 4] = [50u8, 66u8, 74u8, 163u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for Decimals1 {
        const NAME: &'static str = "_decimals";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for Decimals1 {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct Decimals2 {}
    impl Decimals2 {
    ...
    impl substreams_ethereum::Function for Decimals2 {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for Decimals2 {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    pub struct Name1 {}
    impl Name1 {
        const METHOD_ID: [u8; 4] = [210u8, 141u8, 136u8, 82u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for Name1 {
        const NAME: &'static str = "_name";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<String> for Name1 {
    ...
    impl substreams_ethereum::Function for Name2 {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<String> for Name2 {
        fn output(data: &[u8]) -> Result<String, String> {
            Self::output(data)
        }
    }
    ...
    pub struct Symbol1 {}
    impl Symbol1 {
        const METHOD_ID: [u8; 4] = [176u8, 159u8, 18u8, 102u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for Symbol1 {
        const NAME: &'static str = "_symbol";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<String> for Symbol1 {
        fn output(data: &[u8]) -> Result<String, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::Function for Symbol2 {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<String> for Symbol2 {
        fn output(data: &[u8]) -> Result<String, String> {
            Self::output(data)
        }
    }
