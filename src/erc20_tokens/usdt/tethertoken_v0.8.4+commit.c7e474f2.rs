...
pub mod events {
    ...
    impl NewPrivilegedContract {
        const TOPIC_ID: [u8; 32] = [
            120u8, 60u8, 218u8, 99u8, 228u8, 79u8, 156u8, 7u8, 187u8, 228u8, 207u8, 131u8, 154u8,
            20u8, 124u8, 82u8, 147u8, 29u8, 12u8, 213u8, 8u8, 164u8, 147u8, 10u8, 249u8, 209u8,
            101u8, 106u8, 18u8, 1u8, 240u8, 54u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl RemovedPrivilegedContract {
        const TOPIC_ID: [u8; 32] = [
            221u8, 165u8, 11u8, 240u8, 87u8, 14u8, 150u8, 145u8, 64u8, 234u8, 26u8, 65u8, 95u8,
            44u8, 210u8, 99u8, 102u8, 116u8, 171u8, 90u8, 25u8, 64u8, 43u8, 5u8, 41u8, 24u8, 70u8,
            43u8, 88u8, 196u8, 41u8, 126u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
