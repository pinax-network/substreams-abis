...
pub mod functions {
    ...
    impl AuthorizationState {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Address(ethabi::Address::from_slice(&self.authorizer)),
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for CancelAuthorizationTypehash {
    ...
    impl Migrate {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::String(self.name.clone()),
                ethabi::Token::String(self.symbol.clone()),
                ethabi::Token::Address(ethabi::Address::from_slice(&self.oft_contract)),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl Mint {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Address(ethabi::Address::from_slice(&self.destination)),
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.amount.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
                        (num_bigint::Sign::NoSign, bytes) => bytes,
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for ReceiveWithAuthorizationTypehash {
        fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for TransferWithAuthorizationTypehash {
        fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    impl AuthorizationCanceled {
        const TOPIC_ID: [u8; 32] = [
            28u8, 221u8, 70u8, 255u8, 36u8, 39u8, 22u8, 205u8, 170u8, 114u8, 209u8, 89u8, 211u8,
            57u8, 164u8, 133u8, 179u8, 67u8, 131u8, 152u8, 52u8, 141u8, 104u8, 240u8, 157u8, 124u8,
            140u8, 10u8, 89u8, 53u8, 61u8, 129u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
    ...
    impl AuthorizationUsed {
        const TOPIC_ID: [u8; 32] = [
            152u8, 222u8, 80u8, 53u8, 40u8, 238u8, 89u8, 181u8, 117u8, 239u8, 12u8, 10u8, 37u8,
            118u8, 168u8, 36u8, 151u8, 191u8, 192u8, 41u8, 165u8, 104u8, 91u8, 32u8, 158u8, 158u8,
            195u8, 51u8, 71u8, 155u8, 16u8, 165u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
    ...
    impl BlockPlaced {
        const TOPIC_ID: [u8; 32] = [
            64u8, 107u8, 191u8, 45u8, 141u8, 20u8, 81u8, 37u8, 173u8, 241u8, 25u8, 141u8, 44u8,
            248u8, 166u8, 124u8, 102u8, 204u8, 75u8, 176u8, 171u8, 1u8, 195u8, 125u8, 204u8, 212u8,
            247u8, 192u8, 170u8, 225u8, 231u8, 199u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl BlockReleased {
        const TOPIC_ID: [u8; 32] = [
            102u8, 89u8, 24u8, 201u8, 224u8, 46u8, 178u8, 253u8, 133u8, 172u8, 202u8, 57u8, 105u8,
            203u8, 5u8, 79u8, 200u8, 76u8, 19u8, 142u8, 96u8, 236u8, 74u8, 242u8, 42u8, 182u8,
            239u8, 47u8, 212u8, 201u8, 60u8, 39u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl DestroyedBlockedFunds {
        const TOPIC_ID: [u8; 32] = [
            106u8, 40u8, 89u8, 174u8, 121u8, 2u8, 49u8, 55u8, 82u8, 73u8, 143u8, 235u8, 128u8,
            160u8, 20u8, 230u8, 231u8, 39u8, 95u8, 233u8, 100u8, 199u8, 154u8, 169u8, 101u8, 219u8,
            129u8, 93u8, 177u8, 199u8, 241u8, 233u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl LogSetOftContract {
        const TOPIC_ID: [u8; 32] = [
            20u8, 12u8, 127u8, 60u8, 77u8, 209u8, 111u8, 161u8, 2u8, 232u8, 232u8, 102u8, 189u8,
            190u8, 212u8, 85u8, 59u8, 60u8, 190u8, 25u8, 156u8, 160u8, 20u8, 85u8, 17u8, 91u8,
            227u8, 239u8, 199u8, 236u8, 107u8, 98u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl LogUpdateNameAndSymbol {
        const TOPIC_ID: [u8; 32] = [
            144u8, 50u8, 40u8, 18u8, 230u8, 118u8, 30u8, 49u8, 43u8, 153u8, 2u8, 78u8, 137u8,
            231u8, 64u8, 135u8, 20u8, 38u8, 23u8, 9u8, 198u8, 215u8, 248u8, 116u8, 215u8, 150u8,
            146u8, 126u8, 129u8, 58u8, 111u8, 114u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl Redeem {
        const TOPIC_ID: [u8; 32] = [
            112u8, 45u8, 89u8, 103u8, 244u8, 95u8, 101u8, 19u8, 163u8, 143u8, 252u8, 66u8, 214u8,
            186u8, 155u8, 242u8, 48u8, 189u8, 64u8, 232u8, 245u8, 59u8, 22u8, 54u8, 60u8, 126u8,
            180u8, 253u8, 45u8, 235u8, 154u8, 68u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
