...
pub mod functions {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for BasisPointsRate {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MaximumFee {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct TotalSupply1 {}
    impl TotalSupply1 {
        const METHOD_ID: [u8; 4] = [62u8, 170u8, 248u8, 107u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for TotalSupply1 {
        const NAME: &'static str = "_totalSupply";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for TotalSupply1 {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct TotalSupply2 {}
    impl TotalSupply2 {
    ...
    impl substreams_ethereum::Function for TotalSupply2 {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for TotalSupply2 {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    impl Deprecate {
        const TOPIC_ID: [u8; 32] = [
            204u8, 53u8, 134u8, 153u8, 128u8, 94u8, 154u8, 139u8, 127u8, 119u8, 181u8, 34u8, 98u8,
            140u8, 124u8, 185u8, 171u8, 208u8, 125u8, 158u8, 251u8, 134u8, 182u8, 251u8, 97u8,
            106u8, 241u8, 96u8, 144u8, 54u8, 169u8, 158u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl DestroyedBlackFunds {
        const TOPIC_ID: [u8; 32] = [
            97u8, 230u8, 230u8, 107u8, 13u8, 99u8, 57u8, 178u8, 152u8, 10u8, 236u8, 198u8, 204u8,
            192u8, 3u8, 151u8, 54u8, 121u8, 31u8, 12u8, 205u8, 233u8, 237u8, 81u8, 46u8, 120u8,
            154u8, 127u8, 189u8, 214u8, 152u8, 198u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl Issue {
        const TOPIC_ID: [u8; 32] = [
            203u8, 130u8, 65u8, 173u8, 176u8, 195u8, 253u8, 179u8, 91u8, 112u8, 194u8, 76u8, 227u8,
            92u8, 94u8, 176u8, 193u8, 122u8, 247u8, 67u8, 28u8, 153u8, 248u8, 39u8, 212u8, 74u8,
            68u8, 92u8, 166u8, 36u8, 23u8, 106u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl Params {
        const TOPIC_ID: [u8; 32] = [
            176u8, 68u8, 161u8, 228u8, 9u8, 234u8, 197u8, 196u8, 142u8, 90u8, 242u8, 45u8, 74u8,
            245u8, 38u8, 112u8, 221u8, 26u8, 153u8, 5u8, 149u8, 55u8, 167u8, 139u8, 49u8, 180u8,
            140u8, 101u8, 0u8, 166u8, 53u8, 78u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
