...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct PendingGovernor {}
    impl PendingGovernor {
        const METHOD_ID: [u8; 4] = [227u8, 5u8, 106u8, 52u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for PendingGovernor {
        const NAME: &'static str = "pendingGovernor";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for PendingGovernor {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RenounceMinter {}
    impl RenounceMinter {
        const METHOD_ID: [u8; 4] = [152u8, 101u8, 2u8, 117u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for RenounceMinter {
        const NAME: &'static str = "renounceMinter";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
...
pub mod events {
    ...
    impl NewOwnership {
        const TOPIC_ID: [u8; 32] = [
            10u8, 198u8, 222u8, 237u8, 48u8, 238u8, 246u8, 0u8, 144u8, 199u8, 73u8, 133u8, 14u8,
            16u8, 242u8, 250u8, 70u8, 158u8, 62u8, 37u8, 254u8, 193u8, 209u8, 190u8, 242u8, 133u8,
            48u8, 3u8, 246u8, 230u8, 241u8, 143u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
    ...
    impl substreams_ethereum::Event for NewOwnership {
        const NAME: &'static str = "NewOwnership";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct NewPendingOwnership {
        pub from: Vec<u8>,
        pub to: Vec<u8>,
    }
    impl NewPendingOwnership {
        const TOPIC_ID: [u8; 32] = [
            118u8, 86u8, 58u8, 213u8, 97u8, 183u8, 3u8, 106u8, 231u8, 22u8, 185u8, 178u8, 92u8,
            181u8, 33u8, 178u8, 20u8, 99u8, 36u8, 15u8, 16u8, 76u8, 151u8, 225u8, 47u8, 37u8,
            135u8, 127u8, 34u8, 53u8, 243u8, 61u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
    ...
    impl substreams_ethereum::Event for NewPendingOwnership {
        const NAME: &'static str = "NewPendingOwnership";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
