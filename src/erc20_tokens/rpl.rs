...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetInflationCalcTime {}
    impl GetInflationCalcTime {
        const METHOD_ID: [u8; 4] = [127u8, 121u8, 230u8, 74u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for GetInflationCalcTime {
        const NAME: &'static str = "getInflationCalcTime";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for GetInflationCalcTime {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetInflationIntervalRate {}
    impl GetInflationIntervalRate {
        const METHOD_ID: [u8; 4] = [238u8, 150u8, 215u8, 116u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for GetInflationIntervalRate {
        const NAME: &'static str = "getInflationIntervalRate";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetInflationIntervalStartTime {}
    impl GetInflationIntervalStartTime {
        const METHOD_ID: [u8; 4] = [5u8, 52u8, 246u8, 219u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for GetInflationIntervalStartTime {
        const NAME: &'static str = "getInflationIntervalStartTime";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
        for GetInflationIntervalStartTime
    {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetInflationIntervalTime {}
    impl GetInflationIntervalTime {
        const METHOD_ID: [u8; 4] = [99u8, 101u8, 117u8, 16u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for GetInflationIntervalTime {
        const NAME: &'static str = "getInflationIntervalTime";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetInflationIntervalsPassed {}
    impl GetInflationIntervalsPassed {
        const METHOD_ID: [u8; 4] = [185u8, 51u8, 196u8, 158u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for GetInflationIntervalsPassed {
        const NAME: &'static str = "getInflationIntervalsPassed";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
        for GetInflationIntervalsPassed
    {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetInflationRewardsContractAddress {}
    impl GetInflationRewardsContractAddress {
        const METHOD_ID: [u8; 4] = [195u8, 44u8, 54u8, 122u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for GetInflationRewardsContractAddress {
        const NAME: &'static str = "getInflationRewardsContractAddress";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for GetInflationRewardsContractAddress {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct InflationCalculate {}
    impl InflationCalculate {
        const METHOD_ID: [u8; 4] = [193u8, 162u8, 96u8, 6u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for InflationCalculate {
        const NAME: &'static str = "inflationCalculate";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for InflationCalculate {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct InflationMintTokens {}
    impl InflationMintTokens {
        const METHOD_ID: [u8; 4] = [8u8, 130u8, 64u8, 3u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for InflationMintTokens {
        const NAME: &'static str = "inflationMintTokens";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for InflationMintTokens {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl SwapTokens {
        const METHOD_ID: [u8; 4] = [254u8, 120u8, 78u8, 170u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for SwapTokens {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct TotalSwappedRpl {}
    impl TotalSwappedRpl {
        const METHOD_ID: [u8; 4] = [225u8, 80u8, 20u8, 153u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for TotalSwappedRpl {
        const NAME: &'static str = "totalSwappedRPL";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for TotalSwappedRpl {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
...
pub mod events {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RplFixedSupplyBurn {
        pub from: Vec<u8>,
        pub amount: substreams::scalar::BigInt,
        pub time: substreams::scalar::BigInt,
    }
    impl RplFixedSupplyBurn {
        const TOPIC_ID: [u8; 32] = [
            107u8, 170u8, 167u8, 227u8, 119u8, 103u8, 94u8, 86u8, 207u8, 91u8, 114u8, 99u8, 39u8,
            66u8, 163u8, 6u8, 234u8, 45u8, 187u8, 77u8, 243u8, 174u8, 209u8, 197u8, 251u8, 136u8,
            74u8, 248u8, 238u8, 67u8, 108u8, 255u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl substreams_ethereum::Event for RplFixedSupplyBurn {
        const NAME: &'static str = "RPLFixedSupplyBurn";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RplInflationLog {
        pub sender: Vec<u8>,
        pub value: substreams::scalar::BigInt,
        pub inflation_calc_time: substreams::scalar::BigInt,
    }
    impl RplInflationLog {
        const TOPIC_ID: [u8; 32] = [
            67u8, 116u8, 176u8, 149u8, 91u8, 58u8, 9u8, 133u8, 63u8, 221u8, 235u8, 47u8, 214u8,
            20u8, 4u8, 8u8, 100u8, 249u8, 120u8, 129u8, 227u8, 155u8, 124u8, 242u8, 246u8, 237u8,
            234u8, 30u8, 201u8, 65u8, 81u8, 119u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl substreams_ethereum::Event for RplInflationLog {
        const NAME: &'static str = "RPLInflationLog";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
