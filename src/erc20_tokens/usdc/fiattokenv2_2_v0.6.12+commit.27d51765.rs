...
pub mod functions {
    ...
    impl Initialize {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Address(ethabi::Address::from_slice(&self.new_master_minter)),
                ethabi::Token::Address(ethabi::Address::from_slice(&self.new_pauser)),
                ethabi::Token::Address(ethabi::Address::from_slice(&self.new_blacklister)),
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MinterAllowance {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl RescueErc20 {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Address(ethabi::Address::from_slice(&self.token_contract)),
                ethabi::Token::Address(ethabi::Address::from_slice(&self.to)),
                ethabi::Token::Uint(ethabi::Uint::from_big_endian(
                    match self.amount.clone().to_bytes_be() {
                        (num_bigint::Sign::Plus, bytes) => bytes,
...
pub mod events {
    ...
    impl Blacklisted {
        const TOPIC_ID: [u8; 32] = [
            255u8, 164u8, 230u8, 24u8, 23u8, 119u8, 105u8, 37u8, 101u8, 207u8, 40u8, 82u8, 143u8,
            200u8, 143u8, 209u8, 81u8, 110u8, 168u8, 107u8, 86u8, 218u8, 7u8, 82u8, 53u8, 250u8,
            87u8, 90u8, 246u8, 164u8, 184u8, 85u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl BlacklisterChanged {
        const TOPIC_ID: [u8; 32] = [
            198u8, 115u8, 152u8, 1u8, 44u8, 17u8, 28u8, 233u8, 94u8, 203u8, 116u8, 41u8, 185u8,
            51u8, 9u8, 108u8, 151u8, 115u8, 128u8, 238u8, 108u8, 66u8, 17u8, 117u8, 167u8, 26u8,
            74u8, 76u8, 108u8, 136u8, 192u8, 110u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl Burn {
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            ...
            values.reverse();
            Ok(Self {
                burner: ethabi::decode(&[ethabi::ParamType::Address], log.topics[1usize].as_ref())
                    .map_err(|e| {
                        format!(
    ...
    impl MasterMinterChanged {
        const TOPIC_ID: [u8; 32] = [
            219u8, 102u8, 223u8, 169u8, 198u8, 184u8, 245u8, 34u8, 111u8, 233u8, 170u8, 199u8,
            229u8, 24u8, 151u8, 174u8, 142u8, 233u8, 74u8, 195u8, 29u8, 199u8, 11u8, 182u8, 201u8,
            144u8, 11u8, 37u8, 116u8, 183u8, 7u8, 230u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl Mint {
        const TOPIC_ID: [u8; 32] = [
            171u8, 133u8, 48u8, 248u8, 125u8, 201u8, 181u8, 146u8, 52u8, 196u8, 98u8, 59u8, 249u8,
            23u8, 33u8, 43u8, 178u8, 83u8, 109u8, 100u8, 117u8, 116u8, 200u8, 231u8, 229u8, 218u8,
            146u8, 194u8, 237u8, 224u8, 201u8, 248u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
    ...
    impl MinterConfigured {
        const TOPIC_ID: [u8; 32] = [
            70u8, 152u8, 15u8, 202u8, 145u8, 46u8, 249u8, 188u8, 219u8, 211u8, 104u8, 119u8, 66u8,
            123u8, 107u8, 144u8, 232u8, 96u8, 118u8, 159u8, 96u8, 78u8, 137u8, 192u8, 230u8, 119u8,
            32u8, 206u8, 206u8, 83u8, 13u8, 32u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl Pause {
        const TOPIC_ID: [u8; 32] = [
            105u8, 133u8, 160u8, 34u8, 16u8, 161u8, 104u8, 230u8, 102u8, 2u8, 211u8, 35u8, 92u8,
            182u8, 219u8, 14u8, 112u8, 249u8, 43u8, 59u8, 164u8, 211u8, 118u8, 163u8, 60u8, 15u8,
            61u8, 148u8, 52u8, 191u8, 246u8, 37u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl PauserChanged {
        const TOPIC_ID: [u8; 32] = [
            184u8, 4u8, 130u8, 162u8, 147u8, 202u8, 46u8, 1u8, 62u8, 218u8, 134u8, 131u8, 201u8,
            189u8, 127u8, 200u8, 52u8, 124u8, 253u8, 174u8, 234u8, 94u8, 222u8, 88u8, 203u8, 164u8,
            109u8, 245u8, 2u8, 194u8, 166u8, 4u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl RescuerChanged {
        const TOPIC_ID: [u8; 32] = [
            228u8, 117u8, 229u8, 128u8, 216u8, 81u8, 17u8, 52u8, 142u8, 64u8, 216u8, 202u8, 51u8,
            207u8, 221u8, 116u8, 195u8, 15u8, 225u8, 101u8, 92u8, 45u8, 133u8, 55u8, 161u8, 58u8,
            188u8, 16u8, 6u8, 95u8, 250u8, 90u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl UnBlacklisted {
        const TOPIC_ID: [u8; 32] = [
            17u8, 126u8, 50u8, 16u8, 187u8, 154u8, 167u8, 217u8, 186u8, 255u8, 23u8, 32u8, 38u8,
            130u8, 2u8, 85u8, 198u8, 246u8, 195u8, 11u8, 168u8, 153u8, 157u8, 28u8, 47u8, 216u8,
            142u8, 40u8, 72u8, 19u8, 124u8, 78u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl Unpause {
        const TOPIC_ID: [u8; 32] = [
            120u8, 5u8, 134u8, 47u8, 104u8, 158u8, 47u8, 19u8, 223u8, 159u8, 6u8, 47u8, 244u8,
            130u8, 173u8, 58u8, 209u8, 18u8, 172u8, 169u8, 224u8, 132u8, 121u8, 17u8, 237u8, 131u8,
            46u8, 21u8, 140u8, 82u8, 91u8, 51u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
