...
pub mod functions {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for ApproveWithAuthorizationTypehash {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for AuthorizationState {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl Initialize {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Address(ethabi::Address::from_slice(&self.child_chain_manager)),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for MetaTransactionTypehash {
        fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for WithdrawWithAuthorizationTypehash {
        fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            Self::output(data)
        }
    }
