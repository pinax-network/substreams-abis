...
pub mod functions {
        ...
        pub fn output(
            ...
            let mut values = ethabi::decode(
                &[ethabi::ParamType::Tuple(vec![
                    ...
                    ethabi::ParamType::Uint(208usize),
                ])],
                data.as_ref(),
            )
            .map_err(|e| format!("unable to decode output data: {:?}", e))?;
    ...
    impl MinimumTimeBetweenMints {
        const METHOD_ID: [u8; 4] = [13u8, 140u8, 2u8, 5u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for MinimumTimeBetweenMints {
        const NAME: &'static str = "MINIMUM_TIME_BETWEEN_MINTS";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl Mint {
        const METHOD_ID: [u8; 4] = [27u8, 2u8, 90u8, 64u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    pub struct MintCap {}
    impl MintCap {
        const METHOD_ID: [u8; 4] = [152u8, 241u8, 49u8, 46u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MintingAllowedAfter {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct TokenInitialSupply {}
    impl TokenInitialSupply {
        const METHOD_ID: [u8; 4] = [54u8, 194u8, 13u8, 207u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for TokenInitialSupply {
        const NAME: &'static str = "TOKEN_INITIAL_SUPPLY";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for TokenInitialSupply {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl TokenName {
        const METHOD_ID: [u8; 4] = [24u8, 130u8, 20u8, 0u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for TokenName {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<String> for TokenName {
        fn output(data: &[u8]) -> Result<String, String> {
            Self::output(data)
        }
    }
    ...
    impl TokenSymbol {
        const METHOD_ID: [u8; 4] = [42u8, 144u8, 83u8, 24u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for TokenSymbol {
        const NAME: &'static str = "TOKEN_SYMBOL";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<String> for TokenSymbol {
        fn output(data: &[u8]) -> Result<String, String> {
            Self::output(data)
        }
    }
