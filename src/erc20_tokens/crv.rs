...
pub mod functions {
    ...
    impl AvailableSupply {
        const METHOD_ID: [u8; 4] = [36u8, 249u8, 42u8, 37u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for AvailableSupply {
        const NAME: &'static str = "available_supply";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for AvailableSupply {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct FutureEpochTimeWrite {}
    impl FutureEpochTimeWrite {
        const METHOD_ID: [u8; 4] = [178u8, 107u8, 35u8, 142u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for FutureEpochTimeWrite {
        const NAME: &'static str = "future_epoch_time_write";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for FutureEpochTimeWrite {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl MiningEpoch {
        const METHOD_ID: [u8; 4] = [249u8, 164u8, 11u8, 246u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
        ...
        pub fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            let mut values = ethabi::decode(&[ethabi::ParamType::Int(128usize)], data.as_ref())
                .map_err(|e| format!("unable to decode output data: {:?}", e))?;
            Ok({
                let mut v = [0 as u8; 32];
                values
    ...
    impl substreams_ethereum::Function for MiningEpoch {
        const NAME: &'static str = "mining_epoch";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MiningEpoch {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct MintableInTimeframe {
        pub start: substreams::scalar::BigInt,
        pub end: substreams::scalar::BigInt,
    }
    impl MintableInTimeframe {
        const METHOD_ID: [u8; 4] = [215u8, 37u8, 169u8, 202u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for MintableInTimeframe {
        const NAME: &'static str = "mintable_in_timeframe";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for MintableInTimeframe {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    pub struct Rate {}
    impl Rate {
        const METHOD_ID: [u8; 4] = [44u8, 78u8, 114u8, 46u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for Rate {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for Rate {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl SetAdmin {
        const METHOD_ID: [u8; 4] = [233u8, 51u8, 63u8, 171u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for SetAdmin {
        const NAME: &'static str = "set_admin";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl SetMinter {
        const METHOD_ID: [u8; 4] = [22u8, 82u8, 233u8, 252u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl substreams_ethereum::Function for SetMinter {
        const NAME: &'static str = "set_minter";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl SetName {
        const METHOD_ID: [u8; 4] = [225u8, 67u8, 14u8, 6u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            if maybe_data.is_none() {
                return Err("no data to decode".to_string());
    ...
    impl StartEpochTime {
        const METHOD_ID: [u8; 4] = [115u8, 117u8, 190u8, 38u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for StartEpochTime {
        const NAME: &'static str = "start_epoch_time";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for StartEpochTime {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct StartEpochTimeWrite {}
    impl StartEpochTimeWrite {
        const METHOD_ID: [u8; 4] = [173u8, 196u8, 207u8, 67u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for StartEpochTimeWrite {
        const NAME: &'static str = "start_epoch_time_write";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt> for StartEpochTimeWrite {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    ...
    impl UpdateMiningParameters {
        const METHOD_ID: [u8; 4] = [212u8, 59u8, 64u8, 250u8];
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            Ok(Self {})
        }
        pub fn encode(&self) -> Vec<u8> {
    ...
    impl substreams_ethereum::Function for UpdateMiningParameters {
        const NAME: &'static str = "update_mining_parameters";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
...
pub mod events {
    ...
    impl SetAdmin {
        const TOPIC_ID: [u8; 32] = [
            90u8, 39u8, 36u8, 3u8, 180u8, 2u8, 216u8, 146u8, 151u8, 125u8, 245u8, 102u8, 37u8,
            244u8, 22u8, 76u8, 202u8, 247u8, 12u8, 163u8, 134u8, 57u8, 145u8, 196u8, 62u8, 207u8,
            231u8, 106u8, 105u8, 5u8, 176u8, 161u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl SetMinter {
        const TOPIC_ID: [u8; 32] = [
            206u8, 197u8, 33u8, 150u8, 233u8, 114u8, 4u8, 78u8, 221u8, 232u8, 104u8, 154u8, 27u8,
            96u8, 142u8, 69u8, 156u8, 89u8, 70u8, 183u8, 243u8, 229u8, 200u8, 205u8, 61u8, 109u8,
            142u8, 18u8, 109u8, 66u8, 46u8, 28u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl substreams_ethereum::Event for SetMinter {
    ...
    impl UpdateMiningParameters {
        const TOPIC_ID: [u8; 32] = [
            39u8, 228u8, 99u8, 98u8, 161u8, 230u8, 18u8, 155u8, 109u8, 213u8, 57u8, 201u8, 132u8,
            206u8, 115u8, 146u8, 145u8, 169u8, 113u8, 40u8, 223u8, 202u8, 236u8, 161u8, 37u8, 94u8,
            138u8, 200u8, 58u8, 189u8, 148u8, 65u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl substreams_ethereum::Event for UpdateMiningParameters {
        const NAME: &'static str = "UpdateMiningParameters";
        fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            Self::match_log(log)
        }
        fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
